...
public class GradeCalculator {
	...
	private void initialize() {
		...
		lblNewLabel_5 = new JLabel("Lab00");
		...
		lblNewLabel_6 = new JLabel("Lab01");
		...
		lblNewLabel_7 = new JLabel("Lab02");
		...
		lblNewLabel_8 = new JLabel("Lab03");
		...
		lblNewLabel_9 = new JLabel("Lab04");
		...
		lblNewLabel_10 = new JLabel("Lab05");
		...
		lblNewLabel_11 = new JLabel("Lab06");
		...
		lblNewLabel_12 = new JLabel("Lab07");
		...
		lblNewLabel_13 = new JLabel("Lab08");
		...
		lblNewLabel_14 = new JLabel("Lab09");
		...
		lblNewLabel_15 = new JLabel("Lab10");
		...
		lblNewLabel_16 = new JLabel("Lab11");
		...
		lblNewLabel_17 = new JLabel("Lab12");
		...
		lblNewLabel_18 = new JLabel("ExtraCredit");
		...
		btnNewButton.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				...
				JTextField[] tsf = {textField_0, textField_1, textField_2,
						textField_3, textField_4, textField_5, textField_6,
						textField_7, textField_8, textField_9, textField_10, 
						textField_11, textField_12, textField_13, textField_14, 
						textField_15, textField_16, textField_17, textField_18};
				
				try {
					double grade = 0;
					for(JTextField tf : tsf) {
						grade += Double.parseDouble(tf.getText());
					}
				grade /= 2200;
				lblNewLabel_19.setText(grade*100+"%");
				
				} catch (Exception e1) {
					lblNewLabel_20.setText(e1.toString()+ e1.getMessage());
				}
